...
import { Box, Button, ButtonGroup, Grid, Modal, Paper, Typography } from "@mui/material";
...
export default function MyAdvertisementsPage() {
  ...
  return <Box padding={"30px 0"}>
    ...
    <Grid container rowGap={"20px"}>
      {
        ads?.map(ad =>
          <Grid key={ad.id} item xs={3}>
            <AdvertismentComponent onDelete={handleClickDelete} {...ad} />
          </Grid>
        )
      }
    </Grid>
